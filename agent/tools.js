...
export const toolDefinitions = [
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        notes: { type: 'string', description: 'Quest information / briefing context' },
        items: { type: 'string', description: 'Required assets or materials, e.g. "logo files, brand colors"' },
      },
